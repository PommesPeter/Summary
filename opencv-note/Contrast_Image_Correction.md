...
> 以下内容大部分引自：[https://cloud.tencent.com/developer/article/1558535](https://cloud.tencent.com/developer/article/1558535)
...
$$
\begin{cases}
R'=\frac{1}{2}  \begin{bmatrix}\frac{Y'}{Y}(R+Y)+R-Y\end{bmatrix} \\
G'=\frac{1}{2}  \begin{bmatrix}\frac{Y'}{Y}(G+Y)+G-Y\end{bmatrix} \\
B'=\frac{1}{2}   \begin{bmatrix}\frac{Y'}{Y}(B+Y)+B-Y\end{bmatrix} \\
\end{cases}
$$
...
```
## 效果
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200224192421769.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NTcwOTMzMA==,size_16,color_FFFFFF,t_70)


论文原文：[https://www.researchgate.net/publication/220051147_Contrast_image_correction_method](https://www.researchgate.net/publication/220051147_Contrast_image_correction_method)